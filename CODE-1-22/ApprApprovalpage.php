...
<body>
       ...
       $sql = "SELECT activity_title, activity_options, program_organization, date_requested FROM sarf_requests";
       ...
       while ($row = $result->fetch_assoc()) {
           echo "<tr>
                   ...
                   <td class='program_org' onclick='goToApprApproval(\"" . $row["program_organization"] . "\")'>" . $row["program_organization"] . "</td>
