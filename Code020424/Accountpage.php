...
<body>
      <div class="split-background">
        ...
        <div id="page1" class="Content display">
            <?php include('ApproverManage.php'); ?>
        </div>

        <div id="page2" class="Content display">
            <?php include('DirectorManage.php'); ?>
        </div>

        <div id="page3" class="Content display">
            <?php include('StudentManage.php'); ?>
        </div>
