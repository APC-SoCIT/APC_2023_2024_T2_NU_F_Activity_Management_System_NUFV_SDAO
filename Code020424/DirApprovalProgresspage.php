...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    if (isset($_GET['org'])) {
       ...
       $pendingCSS = 'font-size: 12px; font-weight: bold; background-color: rgba(245, 215, 98, 1); margin-top: 2px;
       width: 80px; height: 20px; align-items:center; display: flex; justify-content: center; border-radius: 6px;';
       
       $approvedCSS = 'font-size: 12px; font-weight: bold; background-color: rgba(153, 217, 71, 1); margin-top: 2px;
       width: 80px; height: 20px; align-items:center; display: flex; justify-content: center; border-radius: 6px;';
       
       $approvedImageSrc = 'IMG/check.png';
       $pendingImageSrc = 'IMG/3dotsPending.png';
       $grayPic = 'IMG/grayStatus.png';
       $ImgBackgroundColorPending = 'background-color: rgba(245, 215, 98, 1); height: 34px; width: 37px; border-radius: 50%; 
       display: flex; align-items: center; justify-content: center;';
       $ImgBackgroundColorApproved = 'background-color: rgba(151, 239, 120, 1); height: 34px; width: 37px; border-radius: 50%; 
       display: flex; align-items: center; justify-content: center;';

       $grayImgBackgroundColor = 'background-color: rgba(217, 217, 217, 1);
       height: 34px; width: 37px; height: 37px; width: 38px; border-radius: 50%; display: flex; align-items: center; justify-content: center;';
                ...
                <div class="circleProgressContainer">
                    ...
                    <div id="Requester" class="statusDiv">    
                        ...
                        <div class="circleDetails">
                            ...
                            width: 80px; height: 20px; align-items:center; display: flex; justify-content: center; border-radius: 6px;">SUBMITTED</p>
