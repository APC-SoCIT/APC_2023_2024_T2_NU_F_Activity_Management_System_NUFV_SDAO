...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    if (isset($_GET['org'])) {
       ...
       display: flex; align-items: center; justify-content: center; padding: 1px 0.2px 1px 1px';
...
<!-- --------------------------------------------------------------------------------------------------------------->
                    ...
                    <div class="circleContainer">
                            <div><img src="<?php echo $grayPic; ?>" style="<?php echo $grayImgBackgroundColor; ?>" draggable="false"></div>
                            <div class="statusLine"></div>
...
<!-- ------------------------------------------------------------------------------------------------------------------------->
                ...
                <div class="activityDetailsContainer">
                    ...
                    <div class="rightActivityDetails">
                        ...
                        <div class="rejectBtn" onclick="showRejectRequestSdao()" style="<?php echo $getStatusRedBtn?>"><p id="rejectBtnId">Reject</div>

                        <div class="approveBtn" onclick="approveRequestSdao('<?php echo $org; ?>')" style="<?php echo $btnCursor ?>"><p id="approveBtn"><?php if ($sdaoStatus == 'approved') {
                            echo 'Done';
                            } else{
                                echo 'Approve';
                            }?></p></div>
