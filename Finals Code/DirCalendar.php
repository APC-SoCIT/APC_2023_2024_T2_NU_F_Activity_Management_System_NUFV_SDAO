...
<body>
  <div class="split-background">
    ...
    <img src="IMG/nuStamp.png" alt="Icon" class="nuIcon">
            ...
            <button class="btnNavbar" onclick="loadDirPageContent('DirStatus')">
            <img src="IMG/statusIcon.png" class="statusIcon">Activity Status</button>


            <button class="btnNavbar" onclick="loadDirPageContent('DirApproval')">
            <img src="IMG/approvalworkflowIcon.png" class="approvalworkflowIcon">Approval Workflow</button>
            
            <button class="btnNavbar" onclick="loadDirPageContent('DirTimeline')">
            ...
            <button class="btnNavbar" onclick="loadDirPageContent('DirReports')">
