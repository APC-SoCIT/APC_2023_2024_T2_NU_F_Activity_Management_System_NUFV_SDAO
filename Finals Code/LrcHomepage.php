...
<script>
        ...
        button.addEventListener("click", function() {
            ...
            <div class="bottom">
                <div class="cardHolder">
                    <div class="card" onclick="loadLrcPageContent('LrcStatus')">
                    ...
                    <div class="card" onclick="loadLrcPageContent('LrcApproval')">
                    ...
                    <div class="card" onclick="goToLrcCalendar()">
    ...
    <script>
                function loadLrcPageContent(LrcPage){
                    window.location.href = `LrcNavbarpage.php?LrcPage=${LrcPage}`;
                }
