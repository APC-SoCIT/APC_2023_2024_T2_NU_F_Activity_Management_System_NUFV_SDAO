...
if (isset($_POST["submit"])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $sql = "INSERT INTO `program_chair_approver`(`id`, `program_chair_name`,`program_chair_email`, `program_chair_password`, `program_chair_program`) VALUES (NULL,'$name','$email','$password','$program')";
...
<head>
    ...
    <title>Program Chair's Registration</title>
    <script>
