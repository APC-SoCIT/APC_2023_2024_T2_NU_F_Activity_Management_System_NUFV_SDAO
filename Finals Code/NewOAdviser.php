...
if (isset($_POST["submit"])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $sql = "INSERT INTO `org_adviser_approver`(`id`, `org_adviser_name`,`org_adviser_email`, `org_adviser_password`, `org_adviser_program`) VALUES (NULL,'$name','$email','$password','$program')";
...
<head>
    ...
    <title>Organization Adviser's Registration</title>
    <script>
        ...
        <div class="innerpageContent">
            <div class="container">
                <div class="text-center mb-4">
                    <h3>Add New Organization Adviser</h3>
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="program" class="form-control" name="program" id="program" placeholder="Program" required>
                        </div>
