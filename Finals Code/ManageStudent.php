...
<div class="split-background">
        <div class="left">
            ...
            <ul>
             ...
             <li><a href="ManagePchair.php" class="reports"><img src="" class="statusIcon">Program Chair Accounts</a></li>
    ...
    <div class="right">
        ...
        <h1 class="heading">Student Accounts</h1><br>
        <button class="btn-new" onclick="location.href='NewStudent.php'">Create New</button><br><br>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
      $msg = $_GET["msg"];
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><?php echo $row["program_chair"]?></td>
            <td><?php echo $row["org_adviser"]?></td>
            <td>
            <div class="button-container">
         <button class="btn btn-edit" onclick="window.location.href='EditStudent.php?id=<?php echo $row["id"] ?>'">
            <i class="fa-solid fa-solid fa-trash fs-5"></i>Update
        </button> <br><br>
        <?php
        echo "<a href='DeleteStudent.php?id={$row["id"]}' onclick=\"return confirm('Are you sure to delete this account?');\" class='btn btn-delete' style='text-decoration: none;'>";
