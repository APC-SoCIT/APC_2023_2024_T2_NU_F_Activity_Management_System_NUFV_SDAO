...
if (isset($_POST["submit"])) {
    ...
    $password = $_POST['password'];
        ...
        $sql = "UPDATE `admin` SET `admin_email`='$email',`admin_password`='$password' WHERE id = $id";
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email" value="<?php echo $row['admin_email'] ?>">
                        ...
                        <div>
                            ...
                            <a href="ManageAdmin.php" class="btn btn-danger cancel-btn">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
