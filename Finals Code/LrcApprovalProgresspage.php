...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    ...
    if (isset($_GET['org'])) {
       ...
       $functionForRejectBtn = "showRejectRequestLrc()";

       $approveLrcOnly = "approveLrcOnly('" . $org . "')";
       ...
       if ($OrgAdvStatus == 'approved') {
        ...
        if ($sdaoStatus == 'pending') {
            ...
            $currentFunctionForApproveBtn = $approveLrcOnly;
...
<div class="circleContainer">
        <div class="circle"><img src="<?php echo $imgStatusLRC?>" id="pendingToApproveImg"style="<?php echo $circleIconSize . "" . $borderLRC?>" draggable="false"></div>
        <div style="<?php echo $grayline?>"></div>
                    ...
                    <div class="rightActivityDetails">
                        ...
                        <div id="rejectCommentBox">
                                <div id="rejectCommentBoxContent">
                                    ...
                                    <button onclick="hideRejectRequestLrc()" style="cursor: pointer;" class="overlayCancelBtn">Cancel</button>
