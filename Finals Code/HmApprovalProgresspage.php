...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    ...
    if (isset($_GET['org'])) {
       ...
       $sqlGetDetails = "SELECT hotel_management, learning_resource_center, date_requested, activity_datetime, remarks_tables, remarks_chairs, itso, itso_other from sarf_requests JOIN student_activity_requests on sarf_requests.user_id = student_activity_requests.user_id 
       ...
       $room = $rowGetDetails['hotel_management']; 
       ...
       $functionForRejectBtn = "showRejectRequestHm()";

       $approveHmOnly = "approveHmOnly('" . $org . "')";
       ...
       if ($OrgAdvStatus == 'approved') {
        ...
        if ($sdaoStatus == 'pending') {
            ...
            $hmApproverValue = "Errol Martin";
            $statusRectangleCSSHM = $pendingCSS;
            $borderHM = $borderGoldenRod;
            $currentFunctionForApproveBtn = $approveHmOnly;
            ...
            $hmStatus == 'none' || $hmStatus == 'pending'){
...
<div class="circleContainer">
        <div class="circle"><img src="<?php echo $currentStatusImgSDAO ?>" style="<?php echo $circleIconSize ?>" draggable="false"></div>
        <div class="statusLine"></div>
...
<div class="circleContainer">
        <div class="circle"><img src="<?php echo $imgStatusHM?>" id="pendingToApproveImg"style="<?php echo $circleIconSize . "" . $borderHM?>" draggable="false"></div>
        <div style="<?php echo $grayline?>"></div>
                    ...
                    <div class="rightActivityDetails">
                        ...
                        <div id="rejectCommentBox">
                                <div id="rejectCommentBoxContent">
                                    ...
                                    <button onclick="hideRejectRequestHm()" style="cursor: pointer;" class="overlayCancelBtn">Cancel</button>
