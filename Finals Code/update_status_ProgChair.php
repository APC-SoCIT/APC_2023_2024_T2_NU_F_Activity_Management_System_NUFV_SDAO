...
if (isset($_POST['org'])) {
    ...
    $sqlOrgAdvStatus = "UPDATE sarf.status_of_requests SET prog_chair = 'approved' WHERE user_id = $userId";
    ...
    $sqlinsertDtResponse = "UPDATE sarf.status_response SET pc_dt_response = NOW() WHERE user_id = $userId";
