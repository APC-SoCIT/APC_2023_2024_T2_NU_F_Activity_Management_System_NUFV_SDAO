...
if (isset($_POST["submit"])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $sql = "INSERT INTO `directors_approver`(`id`, `dapprover_name`, `dapprover_email`, `dapprover_password`, `dapprover_position`) VALUES (NULL, '$name','$email','$password', '$position')";
                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="position" class="form-control" name="position" id="position" placeholder="Director" required>
                        </div>
