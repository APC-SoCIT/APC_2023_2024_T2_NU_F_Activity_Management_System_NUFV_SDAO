...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    ...
    if (isset($_GET['org'])) {
       ...
       $functionForApprvBtnCD = "approveRequestCD('" . $org . "')";
       $functionForRejectBtn = "showRejectRequestCD()";
       ...
       $borderGray =  'border: solid 1px; color: gray; padding: 2px;';
        ...
        $borderCD = $borderGray;
        if($OrgAdvStatus=='pending'){
            $cdTxt = '';
            $cdValue = '';

            $currentStatusImgCD = $grayPic;
        ...
        else if($OrgAdvStatus=='approved' && $cdStatus == 'pending'){
            ...
            $currentFunctionForApprvBtn = $functionForApprvBtnCD;
            $currentFunctionForRejectBtn = $functionForRejectBtn;
            $approveBtnText = 'Approve';
            $borderCD = $borderGoldenRod;
            $greenBtnValue ='Approve';
            $cdTxt = 'Program Chair';
            $cdValue = $PC;
                
            }
        else if($OrgAdvStatus=='approved'  && $cdStatus == 'approved'){
            $pcCss = $approvedCSS;
...
<div class="circleContainer">
        <div class="circle"><img src="<?php echo $currentStatusImgCD ?>" id="pendingToApproveImg" style="<?php echo $circleIconSize . "" . $borderCD?>" draggable="false"></div>
        <div class="statusLine"></div>

    </div>
      <div class="circleDetails" style="word-wrap:break-word;">
        <p style="font-weight: bold; font-size: 10px; margin-top: 4px;"><?php $cdTxt ?></p>
        <p style="font-size: 10px; margin-top: 4px;"><?php echo $cdValue?></p>
        <p id="pendingDetail" style="<?php echo $statusRectangleCSS ?>"><?php echo $cdStatusUC ?></p>
        <p style="font-size: 10px; margin-top: 4px; <?php echo $dateDisplayCSS ?>"><?php 
...
<div class="circleContainer">
        <div class="circle"><img src="<?php echo $grayPic; ?>" id="pendingToApproveImg2" style="<?php echo $circleIconSize?>" draggable="false"></div>

        <div style="<?php echo $grayline ?>"></div>

    </div>
    <div class="circleDetails" style="visibility: hidden;">
                        <p style="font-weight: bold; font-size: 10px; margin-top: 4px;"></p>
                        <p style="font-size: 10px; margin-top: 4px;"></p>
                        <p id="pendingDetail2"style=""></p>
                        ...
                        <div id="overlay"></div>
                            <div id="rejectCommentBox">
                                <div id="rejectCommentBoxContent">
                                    ...
                                    <button onclick="hideRejectRequestCD()" class="overlayCancelBtn">Cancel</button>
