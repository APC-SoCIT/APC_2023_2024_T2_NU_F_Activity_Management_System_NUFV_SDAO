...
<body>
  ...
  <div class="left">
    <img src="IMG/nuStamp.png" alt="Icon" class="nuIcon">
            ...
            <button class="btnNavbar" onclick="loadPageContent('Status')">
            <img src="IMG/statusIcon.png" class="statusIcon">Activity Status</button>


            <button class="btnNavbar" onclick="loadPageContent('Approval')">
            <img src="IMG/approvalworkflowIcon.png" class="approvalworkflowIcon">Approval Workflow</button>
            
            <button class="btnNavbar" onclick="loadPageContent('Timeline')">
            ...
            <button class="btnNavbar" onclick="loadPageContent('Reports')">
            <img src="IMG/reportsIcon.png" class="reportsIcon">End Activity Report</button>

            <button id="accBtnNavbar" class="btnNavbar" onclick="loadPageContent('Accounts')">
...
.profilebtn:hover::after {
   ...
   <div class="upper">
   <div class="legend">
      <center><h2 style="font-size: 14px; font-family: sans-serif;">Legend</h2></center>
        <div class="legend-item">
          <div class="legend-marker" style="background-color: #FFDB58;"></div>
          <div style="color: black; font-family: sans-serif; font-size: 13px;">Pending Activites</div>
        </div>
        <div class="legend-item">
          <div class="legend-marker" style="background-color: #90EE90;"></div>
          <div style="color: black; font-family: sans-serif; font-size: 13px;">Approved Activities</div>
        </div>
        <div class="legend-item">
          <div class="legend-marker" style="background-color: #EE4B2B;"></div>
          <div style="color: black; font-family: sans-serif; font-size: 13px;">Rejected Activities</div>
        </div>
    </div>
