...
if (isset($_SESSION['email']) && isset($_SESSION['password'])) {
    ...
    else if($sourceTable == 'program_chair_approver'){
    $department = $org;
    }
?>
...
<script>
        ...
        button.addEventListener("click", function() {
            ...
            <div class="bottom">
                <div class="cardHolder">
                    <div class="card" onclick="loadOrgAdvPageContent('OrgAdvStatus')">
                    ...
                    <div class="card" onclick="loadOrgAdvPageContent('OrgAdvApproval')">
                    ...
                    <div class="card" onclick="goToOrgAdvCalendar()">
    ...
    <script>
                function loadOrgAdvPageContent(OrgAdvPage){
                    window.location.href = `OrgAdvNavbarpage.php?OrgAdvPage=${OrgAdvPage}`;
                }
