...
<head>
  ...
  <title>Facility and Equipment Approver's Account</title>
</head>
...
<div class="split-background">
        <div class="left">
            ...
            <ul>
             ...
             <li><a href="ManageDirector.php" class="reports"><img src="" class="statusIcon">Director Accounts</a></li>
             <li><a href="StudentManage.php" class="form"><img src="" class="statusIcon">Facility and Equipment Accounts</a></li>
    ...
    <div class="right">
        ...
        <h1 class="heading">Facility and Equipment Approver Accounts</h1><br>
        <button class="btn-new" onclick="location.href='NewFacility.php'">Create New</button><br><br>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
      $msg = $_GET["msg"];
    ...
    <table>
      ...
      <tbody>
        <?php
        $sql = "SELECT * FROM `facilities_and_equipment_approver`";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
        ?>
          <tr>
            <td><?php echo $row["id"] ?></td>
            <td><?php echo $row["fapprover_name"] ?></td>
            <td><?php echo $row["fapprover_email"] ?></td>
            <td><?php echo $row["fapprover_position"]?></td>
            <td>
            <div class="button-container">
         <button class="btn btn-edit" onclick="window.location.href='EditFacility.php?id=<?php echo $row["id"] ?>'">
            <i class="fa-solid fa-solid fa-trash fs-5"></i>Update
        </button> 
        <?php
        echo "<a href='DeleteFacility.php?id={$row["id"]}' onclick=\"return confirm('Are you sure to delete this account?');\" class='btn btn-delete' style='text-decoration: none;'>";
