...
<script>
        ...
        button.addEventListener("click", function() {
            ...
            <div class="bottom">
                <div class="cardHolder">
                    <div class="card" onclick="loadItsoPageContent('ItsoStatus')">
                    ...
                    <div class="card" onclick="loadItsoPageContent('ItsoApproval')">
                    ...
                    <div class="card" onclick="goToItsoCalendar()">
    ...
    <script>
                function loadItsoPageContent(ItsoPage){
                    window.location.href = `ItsoNavbarpage.php?ItsoPage=${ItsoPage}`;
                }
