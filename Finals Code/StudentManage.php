...
<body>
    <div class="pageContent">
        ...
        <h1 class="heading">Student Organization's Account(Academic)</h1>
  ...
  <div class="container">
    ...
    ?>
    <button class="btn-new" onclick="location.href='StudentNew.php'">Create New</button>
    ...
    <table>
      ...
      <tbody>
        ...
        ?>
         ...
         <button class="btn btn-edit" onclick="window.location.href='StudentEdit.php?id=<?php echo $row["id"] ?>'">
            <i class="fa-solid fa-solid fa-trash fs-5"></i>Update
        </button> 
        <?php
        echo "<a href='StudentDelete.php?id={$row["id"]}' onclick=\"return confirm('Are you sure to delete this account?');\" class='btn btn-delete' style='text-decoration: none;'>";
