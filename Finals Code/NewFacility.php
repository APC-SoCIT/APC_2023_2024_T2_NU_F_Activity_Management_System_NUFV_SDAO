...
if (isset($_POST["submit"])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $sql = "INSERT INTO `facilities_and_equipment_approver`(`id`, `fapprover_name`,`fapprover_email`, `fapprover_password`, `fapprover_position`) VALUES (NULL,'$name','$email','$password','$position')";
...
<head>
    ...
    <title>Facility and Equipment Approver's Registration</title>
    <script>
        ...
        <div class="innerpageContent">
            <div class="container">
                <div class="text-center mb-4">
                    <h3>Add New Facility and Equipment Approver</h3>
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="position" class="form-control" name="position" id="position" placeholder="Position" required>
                        </div>
