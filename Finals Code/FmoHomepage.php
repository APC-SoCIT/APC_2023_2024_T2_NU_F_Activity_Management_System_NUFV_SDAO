...
<script>
        ...
        button.addEventListener("click", function() {
            ...
            <div class="bottom">
                <div class="cardHolder">
                    <div class="card" onclick="loadFmoPageContent('FmoStatus')">
                    ...
                    <div class="card" onclick="loadFmoPageContent('FmoApproval')">
                    ...
                    <div class="card" onclick="goToFmoCalendar()">
    ...
    <script>
                function loadFmoPageContent(FmoPage){
                    window.location.href = `FmoNavbarpage.php?FmoPage=${FmoPage}`;
                }
