...
<div class="split-background">
        <div class="left">
            ...
            <ul>
             ...
             <li><a href="ManageStudent.php" class="reports"><img src="" class="statusIcon">Student Accounts</a></li>
            </ul>
    ...
    <div class="right">
        ...
        <h1 class="heading">College Dean Accounts</h1><br>
        <button class="btn-new" onclick="location.href='NewDean.php'">Create New</button><br><br>
  <div class="container">
    <?php
    if (isset($_GET["msg"])) {
      $msg = $_GET["msg"];
    ...
    <table>
      ...
      <tbody>
        <?php
        $sql = "SELECT * FROM `college_dean_approver`";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
        ?>
          <tr>
            <td><?php echo $row["id"] ?></td>
            <td><?php echo $row["college_dean_name"] ?></td>
            <td><?php echo $row["college_dean_email"] ?></td>
            <td><?php echo $row["college_dean_department"]?></td>
            <td>
            <div class="button-container">
         <button class="btn btn-edit" onclick="window.location.href='EditDean.php?id=<?php echo $row["id"] ?>'">
            <i class="fa-solid fa-solid fa-trash fs-5"></i>Update
        </button> <br><br>
        <?php
        echo "<a href='DeleteDean.php?id={$row["id"]}' onclick=\"return confirm('Are you sure to delete this account?');\" class='btn btn-delete' style='text-decoration: none;'>";
