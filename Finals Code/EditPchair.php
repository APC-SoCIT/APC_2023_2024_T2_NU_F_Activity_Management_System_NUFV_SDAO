...
if (isset($_POST["submit"])) {
    ...
    $program = $_POST['program'];
        ...
        $sql = "UPDATE `program_chair_approver` SET `program_chair_name`='$name',`program_chair_email`='$email',`program_chair_password`='$password',`program_chair_program`='$program' WHERE id = $id";
...
<div class="split-background">
    ...
    <div class="pageContent">
        <div class="innerpageContent">
            ...
            <div class="container">
            <h1 class="heading">Program Chair's Account</h1>
                <div class="text-center mb-4">
                    <p class="text-muted">Click update after changing any information</p>
                </div>

                <?php
                $sql = "SELECT * FROM `program_chair_approver` WHERE id = $id LIMIT 1";
                $result = mysqli_query($conn, $sql);
                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="mb-3">
                            ...
                            <input type="name" class="form-control" name="name" value="<?php echo $row['program_chair_name'] ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Email:</label>
                            <input type="email" class="form-control" name="email" value="<?php echo $row['program_chair_email'] ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="program" class="form-control" name="program" value="<?php echo $row['program_chair_program'] ?>">
                        </div>

                        <div>
                            <button type="submit" class="btn btn-success" name="submit">Update</button>
                            <a href="ManagePchair.php" class="btn btn-danger cancel-btn">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
