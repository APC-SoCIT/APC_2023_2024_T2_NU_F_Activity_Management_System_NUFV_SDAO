...
if (isset($_POST["submit"])) {
    ...
    $position = $_POST['position'];
        ...
        $sql = "UPDATE `directors_approver` SET `dapprover_name`='$name',`dapprover_email`='$email',`dapprover_password`='$password',`dapprover_position`='$position' WHERE id = $id";
...
<div class="split-background">
        <div class="left">
            ...
            <ul>
             ...
             <li><a href="ManageDirector.php" class="form"><img src="" class="statusIcon">Director Accounts</a></li>
    ...
    <div class="pageContent">
        <div class="innerpageContent">
            ...
            <div class="container">
            <h1 class="heading">Director's Account</h1>
                <div class="text-center mb-4">
                    <p class="text-muted">Click update after changing any information</p>
                </div>

                <?php
                $sql = "SELECT * FROM `directors_approver` WHERE id = $id LIMIT 1";
                $result = mysqli_query($conn, $sql);
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="name" class="form-control" name="name" value="<?php echo $row['dapprover_name'] ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Email:</label>
                            <input type="email" class="form-control" name="email" value="<?php echo $row['dapprover_email'] ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="position" class="form-control" name="position" value="<?php echo $row['dapprover_position'] ?>">
                        </div>

                        <div>
                            <button type="submit" class="btn btn-success" name="submit">Update</button>
                            <a href="ManageDirector.php" class="btn btn-danger cancel-btn">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
