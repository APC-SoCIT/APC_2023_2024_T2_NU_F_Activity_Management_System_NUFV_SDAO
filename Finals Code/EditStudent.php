...
if (isset($_POST["submit"])) {
    ...
    $org_adviser = $_POST['org_adviser'];
        ...
        $sql = "UPDATE `studentaccounts` SET `email`='$email',`password`='$password',`program_organization`='$program',`program_chair`='$program_chair',`org_adviser`='$org_adviser' WHERE id = $id";
...
<div class="split-background">
    ...
    <div class="pageContent">
        <div class="innerpageContent">
            ...
            <div class="container">
            <h1 class="heading">Student's Account</h1>
                ...
                <div class="container d-flex justify-content-center">
                    <form action="" method="post" style="width:50vw; min-width:300px;">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="program" class="form-control" name="program" value="<?php echo $row['program_organization'] ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Program Chair:</label>
                            <input type="program_chair" class="form-control" name="program_chair" value="<?php echo $row['program_chair'] ?>">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Organization Adviser:</label>
                            <input type="org_adviser" class="form-control" name="org_adviser" value="<?php echo $row['org_adviser'] ?>">
                        </div>
